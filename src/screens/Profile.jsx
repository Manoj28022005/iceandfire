    ...
    <>
      <div className="dropdown">
        ...
        <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton1">
          <li><a className="dropdown-item" href={"https://iceandfire-frontend.vercel.app/my-orders"} style={{ fontWeight: 'normal' }}>My Orders</a></li>
          <li>
          ...
          <li><a className="dropdown-item" href={"https://iceandfire-frontend.vercel.app/support"} style={{ fontWeight: 'normal' }}>Support</a></li>
